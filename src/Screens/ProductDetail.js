...
//             if (selectedQuality && selectedQuality.value.quality === should1.value.quality) {
//               // If the selected quality matches the cart quality, increase quantity by 1
//               setQuantity(cartItem.qty + 1);
//             } else {
//               // If quality changes or not found, reset quantity to 1 or handle as needed
//               setQuantity(1);
//             }
//           } else {
//             // Handle when the product is not in the cart
...
//             placeholder={_product.quality}
//             value={should1}
//             onChange={(item) => { setShould1(item), taxdetail(item), productlistapi1(item, list?.id) }}
//           />
//           <View style={{
//             marginTop: 10,
//             flexDirection: 'row', justifyContent: 'space-between',
